...
public static class MockedRequestExtensions
{
    ...
    /// <returns>The <see cref="T:MockedRequest"/> instance</returns>
    public static MockedRequest WithQueryString(this MockedRequest source,
    ...
    /// <param name="values">The query string key/value pairs to match</param>
    /// <returns>The <see cref="T:MockedRequest"/> instance</returns>
    public static MockedRequest WithExactQueryString(this MockedRequest source,
        IEnumerable<KeyValuePair<string, string>> values)
    {
    ...
    /// <param name="values">The query string key/value pairs to match</param>
    /// <returns>The <see cref="T:MockedRequest"/> instance</returns>
    public static MockedRequest WithFormData(this MockedRequest source,
        IEnumerable<KeyValuePair<string, string>> values)
    {
    ...
    /// <param name="values">The query string key/value pairs to match</param>
    /// <returns>The <see cref="T:MockedRequest"/> instance</returns>
    public static MockedRequest WithExactFormData(this MockedRequest source,
        IEnumerable<KeyValuePair<string, string>> values)
    {
    ...
    /// <returns>The <see cref="T:MockedRequest"/> instance</returns>
    public static MockedRequest WithHeaders(this MockedRequest source,
    ...
    /// <param name="content">The content of the response</param>
    public static MockedRequest Respond(this MockedRequest source, HttpStatusCode statusCode,
        IEnumerable<KeyValuePair<string, string>> headers, HttpContent content)
    {
    ...
    public static MockedRequest Respond(this MockedRequest source, string mediaType,
    ...
    /// <param name="handler">A delegate that will return a content stream at runtime</param>
    public static MockedRequest Respond(this MockedRequest source, HttpStatusCode statusCode,
        IEnumerable<KeyValuePair<string, string>> headers, string mediaType, Func<HttpRequestMessage, Stream> handler)
    {
    ...
    public static MockedRequest Respond(this MockedRequest source, IEnumerable<KeyValuePair<string, string>> headers,
        string mediaType, Stream content)
    {
        return source.Respond(HttpStatusCode.OK, headers, mediaType, content);
    }
    ...
    /// <param name="handler">The delegate that will return a <see cref="T:HttpContent"/> determined at runtime</param>
    public static MockedRequest Respond(this MockedRequest source, IEnumerable<KeyValuePair<string, string>> headers,
        Func<HttpRequestMessage, HttpContent> handler)
    {
    ...
    /// <param name="handler">The delegate that will return a <see cref="T:HttpContent"/> determined at runtime</param>
    public static MockedRequest Respond(this MockedRequest source, HttpStatusCode statusCode,
        IEnumerable<KeyValuePair<string, string>> headers, Func<HttpRequestMessage, HttpContent> handler)
    {
        return source.Respond(req =>
        {
            HttpResponseMessage res = new(statusCode)
    ...
    {
        return source.Respond(req => TaskExtensions.FromResult(handler(req)));
    }
    ...
    {
        return source.Respond(req => { throw exception; });
    }
